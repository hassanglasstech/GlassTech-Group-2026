          ...
          <tbody>
            {filteredClients.length > 0 ? filteredClients.map((client) => (
              <tr key={client.id} className="group hover:bg-slate-50 transition-colors">
                ...
                <td className="px-4 py-3">
                  <p className="text-xs font-black text-red-600">PKR {(client.creditLimit ?? 0).toLocaleString()}</p>
                </td>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-center">
                  <div className="flex justify-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="text-slate-400 hover:text-red-600"><Edit2 size={14} /></button>
            ...
            <div className="p-8 grid grid-cols-2 gap-8 bg-slate-50 overflow-y-auto max-h-[70vh]">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <input type="number" className="sap-input w-full font-black text-red-600" value={formData.creditLimit} onChange={e => setFormData({...formData, creditLimit: Number(e.target.value)})} />
                </div>
                <div className="space-y-1">
...
export default NipponClientMaster;
