...
import { BarChart3, TrendingUp, Users, FileSignature, DollarSign, Filter } from 'lucide-react';

const NipponSalesPipeline: React.FC<{ company: Company }> = ({ company }) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-2xl border shadow-sm flex flex-col justify-between">
                    <div className="flex justify-between items-start mb-4">
                        <div className="p-3 bg-red-50 text-red-600 rounded-xl"><FileSignature size={24}/></div>
                ...
                <div className="bg-white p-6 rounded-2xl border shadow-sm flex flex-col justify-between">
                    ...
                    <div>
                        <h4 className="text-3xl font-black text-red-600">{stats.winRate.toFixed(1)}%</h4>
                        <p className="text-xs font-bold text-red-400 uppercase mt-1">Conversion</p>
                    </div>
                </div>
            </div>
                            ...
                            {quotations.slice(0, 10).map(q => {
                                ...
                                return (
                                    <tr key={q.id} className="hover:bg-slate-50 transition-colors">
                                        <td className="px-6 py-4 font-black text-red-600 uppercase text-xs">{q.id}</td>
...
export default NipponSalesPipeline;
