...
import { GatePass, TemperingDispatch, ProductionPiece, Quotation, Client, Vendor } from '../../../shared/types';
...
const NipponLogistics: React.FC = () => {
...
export default NipponLogistics;
