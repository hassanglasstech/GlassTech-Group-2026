...
import { Search, Box, Image as ImageIcon } from 'lucide-react';
...
const StockOverview: React.FC<StockOverviewProps> = ({ items, searchTerm, setSearchTerm }) => {
    ...
    const filteredItems = useMemo(() => {
        return items.filter(i => {
            // const product = allProducts.find(p => p.id === i.id); // Not strictly needed for filtering by name, but kept if logic expands
