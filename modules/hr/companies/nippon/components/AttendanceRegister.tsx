...
import { Company, Employee, AttendanceRecord, AttendanceStatus, Requisition } from '@/modules/shared/types';
...
const AttendanceRegister: React.FC<{ company: Company }> = ({ company }) => {
