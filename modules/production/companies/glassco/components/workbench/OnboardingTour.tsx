...
const OnboardingTour: React.FC<OnboardingTourProps> = ({ forceShow, onClose }) => {
  ...
  return (
    <>
      ...
      {rect && (
        <div
          className="fixed z-[401] pointer-events-none rounded-lg ring-4 ring-blue-400 ring-offset-2 ring-offset-transparent transition-all duration-200"
          style={{
            left:   rect.left - 6,
            top:    rect.top - 6,
            width:  rect.width + 12,
      ...
      <div
        ...
        className="fixed z-[402] bg-white rounded-xl shadow-2xl p-4 w-[300px] max-w-[90vw]"
        style={tooltipStyle}
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between mb-1.5">
          <span className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-wider text-blue-600">
