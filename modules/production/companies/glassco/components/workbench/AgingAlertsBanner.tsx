    ...
    <div className={`border-b ${toneClass} px-4 py-2 flex items-center gap-3 text-xs`}>
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 flex-1">
        ...
        {red > 0 && (
          ...
          >
            <span className="bg-rose-600 text-white rounded-full w-5 h-5 flex items-center justify-center font-black text-[10px]">{red}</span>
        ...
        {amber > 0 && (
          <span className="flex items-center gap-1">
            <span className="bg-amber-500 text-white rounded-full w-5 h-5 flex items-center justify-center font-black text-[10px]">{amber}</span>
            at-risk (3–7d)
          </span>
        )}
        ...
        {lateReturns > 0 && (
          <Link
            ...
            className="font-bold underline hover:opacity-80 flex items-center gap-1"
          >
            <span className="bg-rose-600 text-white rounded-full w-5 h-5 flex items-center justify-center font-black text-[10px]">{lateReturns}</span>
        ...
        {licenseExp > 0 && (
          <span className="flex items-center gap-1">
            <span className="bg-amber-500 text-white rounded-full w-5 h-5 flex items-center justify-center font-black text-[10px]">{licenseExp}</span>
