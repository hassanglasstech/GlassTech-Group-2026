...
/**
 * Nippon quotation — built on the Glassco print model, which has always printed
 * correctly.
 *
        ...
        <div className="nippon-print-page bg-white text-black p-0 font-sans leading-tight">
            ...
            <div className="print-footer" style={{ pageBreakInside: 'avoid', breakInside: 'avoid' }}>
                ...
                {/* Footer identity — contact + bank + catalogue QR + system line.
                    `page-bottom-footer` pins this to the bottom of EVERY printed
                    page (see PRINT_STYLES); on screen it just flows. The QR is no
                    longer forced on here — Admin -> Branding owns that toggle. */}
