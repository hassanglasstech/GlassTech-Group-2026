                ...
                <div className="flex-1 overflow-y-auto p-10 bg-slate-50 space-y-10">
                    <div className="grid grid-cols-4 gap-6">
                        ...
                        <div className="bg-white p-6 rounded-2xl border shadow-sm">
                            ...
                            <p className="text-2xl font-black text-rose-600">PKR {totalConsumed.toLocaleString()}</p>
                        </div>
                    ...
                    <div className="bg-white p-8 rounded-[2rem] border border-blue-200 shadow-sm relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-3 gap-12">
                            ...
                            <div>
                                ...
                                <p className="text-3xl font-black text-rose-600">PKR {totalConsumed.toLocaleString()}</p>
                            </div>
                            <div>
                                <p className="text-[10px] font-black text-slate-400 uppercase mb-1">Net Estimated Profit</p>
                                <p className={`text-3xl font-black ${profit >= 0 ? 'text-emerald-600' : 'text-rose-600'}`}>PKR {profit.toLocaleString()}</p>
